 ...
 * @version: 1.0
 * @Author: YKLiu
 * @Date: 2020-03-02 14:46:49
 * @LastEditTime: 2020-03-05 17:57:15
 */
#include "fx_hpca.h"
#include "op_api.h"
#include <stdbool.h>
...
void restnet50_main(char *argparam, int net_type)
{
	...
	{
		resnet50_initial_weight(net_type, boundary[0]);
		resnet50_test_block(boundary[0], boundary[1], net_type);
	}
	else
	{
